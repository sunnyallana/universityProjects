...
// Method to assess mind of a person
	void computeMind() {
		...
		ifstream mindFile("personality/mind.txt");
...
// Method to assess energy of a person
	void computeEnergy() {
		...
		ifstream energyFile("personality/energy.txt");
		try {
			for (int i = 0; i < 5; i++) {
...
// Method to assess nature of a person
	void computeNature() {
		...
		ifstream natureFile("personality/nature.txt");
		try {
			for (int i = 0; i < 5; i++) {
...
// Method to assess tactics of a person
	void computeTactics() {
		...
		ifstream tacticsFile("personality/tactics.txt");
		try {
			for (int i = 0; i < 5; i++) {
...
// Method to assess identity of a person
	void computeIdentity() {
		...
		ifstream identityFile("personality/identity.txt");
		try {
			for (int i = 0; i < 5; i++) {
